...
export const translations: Record<string, Translations> = {
  en: {
    ...
    hjTarget: 'Target',
    hjOptional: 'Optional',
    hjMaxTooltip: '7 optional enemies that isn\'t required for achievement: Shakra, Garmond & Zaza, Summoned Saviour (Steel Soul mode only), Flintbeetle, Palestag, Lost Garmond, Lost Lace',
    hjMaxLabel: '(237 max)',
